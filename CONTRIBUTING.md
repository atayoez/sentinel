...
**[Contributing wiki page](https://github.com/atayoez/sentinel/wiki/Contributing)**;
...
- **Bugs that aren't security issues**: open a
  [bug report](https://github.com/atayoez/sentinel/issues/new/choose).
...
[Discussions](https://github.com/atayoez/sentinel/discussions)
rather than issues.
