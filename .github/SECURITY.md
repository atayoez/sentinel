...
1. **GitHub Private Vulnerability Reporting** — preferred. From
   the [Security tab](https://github.com/atayozcan/sentinel-cosmic/security)
...
- A GitHub Security Advisory is published from the [Security tab](https://github.com/atayozcan/sentinel-cosmic/security/advisories).
...
- A malicious compositor or process running as your user that injects
  ...
  section in the [Architecture](https://github.com/atayozcan/sentinel-cosmic/wiki/Architecture)
  wiki page.
