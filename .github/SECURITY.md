...
1. **GitHub Private Vulnerability Reporting** — preferred. From
   the [Security tab](https://github.com/atayoez/sentinel/security)
...
- A GitHub Security Advisory is published from the [Security tab](https://github.com/atayoez/sentinel/security/advisories).
...
- A malicious compositor or process running as your user that injects
  ...
  section in the [Architecture](https://github.com/atayoez/sentinel/wiki/Architecture)
  wiki page.
