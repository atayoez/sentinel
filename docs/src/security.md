...
[`.github/SECURITY.md`](https://github.com/atayoez/sentinel/blob/main/.github/SECURITY.md)
in the repo root and is what GitHub renders on the
[security tab](https://github.com/atayoez/sentinel/security).
This page is a brief summary; reporters should follow the canonical
copy.

## Reporting a vulnerability

1. **Preferred:** [GitHub Private Vulnerability Reporting](https://github.com/atayoez/sentinel/security)
