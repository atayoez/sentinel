...
The [PR template](https://github.com/atayozcan/sentinel-cosmic/blob/main/.github/pull_request_template.md)
...
Use [bug_report.yml](https://github.com/atayozcan/sentinel-cosmic/issues/new?template=bug_report.yml)
for general bugs, or [compositor_compat.yml](https://github.com/atayozcan/sentinel-cosmic/issues/new?template=compositor_compat.yml)
...
scope?") go in [Discussions](https://github.com/atayozcan/sentinel-cosmic/discussions)
rather than issues.

## License

By contributing you agree your changes ship under
[GPL-3.0-or-later](https://github.com/atayozcan/sentinel-cosmic/blob/main/LICENSE),
