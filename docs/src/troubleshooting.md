...
[`bug_report.yml`](https://github.com/atayoez/sentinel/issues/new?template=bug_report.yml)
is the standard template. For compositor compatibility specifically,
the [compositor compat template](https://github.com/atayoez/sentinel/issues/new?template=compositor_compat.yml)
